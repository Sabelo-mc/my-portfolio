...
<div align="center">
  ...
  <br><br>
  <strong>“Developing Professional Readiness through Reflection, Evidence, and Continuous Growth.”</strong>
</div>
...
By applying the Collect, Select, Reflect, and Connect approach, I have compiled relevant artefacts and STAR-based reflections that highlight my development in essential employability skills.

The content within this portfolio represents my academic achievements as well as my personal growth, illustrating how I am preparing myself for entry into the professional IT field.
...
| Step | Description |
|------|--------------|
| **Collect** | Compiled various pieces of evidence from the Work Readiness modules, such as screenshots and completed activities.. |
| **Select** | Picked the artefacts that most effectively showcase the skills learned and the progress made throughout the modules. |
| **Reflect** | Used the STAR method (Situation, Task, Action, Result) to create clear, well-structured reflections on each experience. |
| **Connect** | Linked each learning moment to long-term personal and career goals, showing how these insights support future professional growth. |
...
**Task:**  
My goal was to master the appropriate tone, format, and structure required for formal business communication.

**Action:**  
I practiced drafting professional emails, applied key grammar principles, and learned how to differentiate between formal and informal communication styles. I also took part in discussions about communication barriers and proper digital etiquette.

**Result:**  
I am now able to produce well-structured professional messages, deliver clear presentations, and communicate effectively in both written and verbal professional settings.
...
**Task:**  
My objective was to learn how to structure my answers effectively, convey confidence, and clearly align my abilities with the requirements of potential employers.

**Action:**  
I completed the Interview Skills module, practiced responding to typical interview questions using the STAR framework, and improved my non-verbal communication, including posture, eye contact, and body language.
...
**Task:**  
My goal was to put the interview techniques I had learned into practice and gain constructive feedback on my performance.  
...
**Task:**  
My aim was to develop a polished online professional profile and connect effectively with individuals and communities within my industry.

**Action:**  
I set up a LinkedIn profile, expanded my network by connecting with industry professionals, and participated in virtual career readiness events offered by CPUT. I also interacted with career-related content to stay informed and aligned with my professional goals.
...
**Task:**  
My goal was to learn how to consistently demonstrate respect, collaborate effectively, be punctual, and maintain strong ethical standards at work.
...
These skills have equipped me to:
- Communicate clearly and confidently in professional settings.
- Excel in job interviews by presenting my skills effectively.
- Participate actively and meaningfully in workplace and networking environments.
- Uphold professional behavior and strong ethical standards.

---

<div align="center">

> “Professional growth isn’t a fixed endpoint it’s an ongoing journey of learning, reflecting, and taking action.”
> — *Sabelo Mashego(2025), Personal Reflection, PRP372S Digital Portfolio*
